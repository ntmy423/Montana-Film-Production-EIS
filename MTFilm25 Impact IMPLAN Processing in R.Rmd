...
implan_output_file_name = "20260319-MTFilm25-Detail Economic Indicators.csv"
...
write.csv(output_economic_impact, "output_files/economicimpact_tables_MTFilm25.csv", na = "", row.names = FALSE)
write.csv(output_industry_distribution, "output_files/industryemployment_distribution_MTFilm25.csv", na = "", row.names = FALSE)
