...
implan_output_file_name = "20260319-MTFilmMissing2425-Detail Economic Indicators.csv"
...
write.csv(output_economic_impact, "output_files/economicimpact_tables_MTFilmMissing2425.csv", na = "", row.names = FALSE)
write.csv(output_industry_distribution, "output_files/industryemployment_distribution_MTFilmMissing2425.csv", na = "", row.names = FALSE)
